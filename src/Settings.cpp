...
void Settings::load() {
  ...
  if (!m_settings.contains(OPTION_REMOTE_NODE)) {
    m_settings.insert(OPTION_REMOTE_NODE, "node.aluisyo.network:19000");
  }
  ...
  defaultPoolList << "pool.aluisyo.network:3333" << "coinsforhash.tk:3379";
  ...
  defaultNodesList << "node.aluisyo.network:19000";
